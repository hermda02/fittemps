program template_fitting
  ...
  character(len=128)  :: no_fg_map, fg_map, dust_amp, foreground
  ...
  dust_amp    = 'amplitudes/dust_amplitudes/dust_amplitudes.dat'
...
11 format (I2)
  ...
  do i = 1,9
     ...
     write(number,10) i
     no_fg_map    = 'amplitudes/maps/nofg_band0'// trim(number) //'.fits'
     fg_map       = 'amplitudes/maps/'//trim(foreground) //'_band0'// trim(number) //'.fits'
     residual_map = 'amplitudes/maps/no_' // trim(foreground) // '_band0'// trim(number) //'.fits'
  ...
  do i = 10,total
     ...
     ! Initializing the input/output maps and foreground templates
     write(number,11) i
     no_fg_map    = 'amplitudes/maps/nofg_band'// trim(number) //'.fits'
     fg_map       = 'amplitudes/maps/'//trim(foreground) //'_band'// trim(number) //'.fits'
     residual_map = 'amplitudes/maps/no_' // trim(foreground) // '_band'// trim(number) //'.fits'
